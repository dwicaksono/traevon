...
import { CreateDraftDto, FinalizeDraftDto, ListDraftsQueryDto, DraftListResponseDto, DraftIdParam, DraftResponseDto, ErrorResponseDto, } from "../../modules/drafts/draft.dto.js";
...
const createDraftRoute = createRoute({
    ...
    description: "Rule 2: Any LLM output must land here as a Draft object first. " +
...
const finalizeRoute = createRoute({
    ...
    description: "Atomically approves a draft and writes it to the external source system. " +
